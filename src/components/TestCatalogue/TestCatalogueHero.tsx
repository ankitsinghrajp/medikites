      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span>Comprehensive Testing Solutions</span>
          </motion.div>
          ...
          >
            ...
            >
              ...
              offers a wide range of pathology and diagnostic tests, covering routine screenings to advanced investigations, ensuring accurate results and comprehensive health assessment under one roof.
            </p>
          </motion.div>
