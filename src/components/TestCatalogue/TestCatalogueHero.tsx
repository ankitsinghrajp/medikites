    ...
    <div className="relative h-[440px] pt-10 md:pt-20 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        ...
        <div className={`space-y-6 transform transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          ...
          >
            <span className="text-blue-400 font-semibold">MediKites</span> offers a wide range of pathology and diagnostic tests, covering routine screenings to advanced investigations, ensuring accurate results and comprehensive health assessment under one roof.
          </p>
        </div>
...
export default TestCatalogueHero;