  ...
  const backgroundData = [
    {
      ...
      buttons: [
        { text: "Call Now", icon: Phone, variant: "white", link: "tel:+916200837385" },
        { text: "WhatsApp", icon: MessageCircle, variant: "green", link: "https://wa.me/916200837385" },
        { text: "Book Urgent Test", icon: Zap, variant: "red", link: "#book" }
      ]
    },
    {
      ...
      buttons: [
        { text: "View Tests", icon: List, variant: "white", link: "#tests" },
        { text: "Schedule Now", icon: Calendar, variant: "dark", link: "#schedule" }
      ]
    },
    {
      ...
      buttons: [
        { text: "Book Home Collection", icon: Home, variant: "white", link: "#home-collection" },
        { text: "Visit Lab", icon: MapPin, variant: "outline", link: "#visit" }
      ]
    }
  ];
  
  // Auto-slide functionality - 2 seconds
  useEffect(() => {
